            ...
            <div class="row">
                <div class="col-xl-3 col-lg-6 col-md-6">
                    <a href="hotel-detail.html" class="grid_item">
                        <figure>
                            ...
                            <img src="{{ url('frontend/img/hotel_1.jpg')}}" class="img-fluid" alt="">
                            <div class="info">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6">
                    <a href="hotel-detail.html" class="grid_item">
                        <figure>
                            ...
                            <img src="{{ url('frontend/img/hotel_2.jpg')}}" class="img-fluid" alt="">
                            <div class="info">
                                <div class="cat_star"><i class="icon_star"></i><i class="icon_star"></i><i class="icon_star"></i><i class="icon_star"></i></div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6">
                    <a href="hotel-detail.html" class="grid_item">
                        <figure>
                            <div class="score"><strong>8.9</strong></div>
                            <img src="{{ url('frontend/img/hotel_4.jpg')}}" class="img-fluid" alt="">
                            <div class="info">
                                <div class="cat_star"><i class="icon_star"></i><i class="icon_star"></i><i class="icon_star"></i><i class="icon_star"></i></div>
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-6 col-md-6">
                    <a href="restaurant-detail.html" class="grid_item">
                        <figure>
                            ...
                            <img src="{{ url('frontend/img/restaurant_1.jpg')}}" class="img-fluid" alt="">
                            <div class="info">
                                <h3>Da Alfredo</h3>
                            </div>
                        </figure>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6">
                    <a href="restaurant-detail.html" class="grid_item">
                        <figure>
                            <div class="score"><strong>7.9</strong></div>
                            <img src="{{ url('frontend/img/restaurant_2.jpg')}}" class="img-fluid" alt="">
                            <div class="info">
                                <h3>Slow Food</h3>
                            </div>
                        </figure>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6">
                    <a href="restaurant-detail.html" class="grid_item">
                        <figure>
                            ...
                            <img src="{{ url('frontend/img/restaurant_3.jpg')}}" class="img-fluid" alt="">
                            <div class="info">
                                <h3>Bella Napoli</h3>
                            </div>
                        </figure>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6">
                    <a href="restaurant-detail.html" class="grid_item">
                        <figure>
                            ...
                            <img src="{{ url('frontend/img/restaurant_4.jpg')}}" class="img-fluid" alt="">
                            <div class="info">
                                <h3>Marcus</h3>
                            </div>
                        </figure>
    ...
    <div class="bg_color_1">
        <div class="container margin_80_55">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <a class="box_news" href="#0">
                        <figure><img src="{{ url('frontend/img/news_home_2.jpg')}}" alt="">
                            <figcaption><strong>28</strong>Dec</figcaption>
                        </figure>
                        <ul>
                            <li>Jhon Doe</li>
                ...
                <div class="col-lg-6">
                    <a class="box_news" href="#0">
                        <figure><img src="{{ url('frontend/img/news_home_3.jpg')}}" alt="">
                            <figcaption><strong>28</strong>Dec</figcaption>
                        </figure>
                        <ul>
                            <li>Luca Robinson</li>
                ...
                <div class="col-lg-6">
                    <a class="box_news" href="#0">
                        <figure><img src="{{ url('frontend/img/news_home_4.jpg')}}" alt="">
                            <figcaption><strong>28</strong>Dec</figcaption>
                        </figure>
                        <ul>
