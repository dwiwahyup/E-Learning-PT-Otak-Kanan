...
<head>
    ...
    <!-- Favicons-->
    <link href="{{ url('https://res.cloudinary.com/djbbzawzs/image/upload/v1673887767/picture_assets_frontend/cropped-ok-ico-32x32_e4lvma.png')}}"rel="shortcut icon"  type="image/x-icon">
