...
<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <form action="{{route('program.kompetensi.store', $program->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Nama Kompetensi</label>
                                <input type="text" class="form-control" placeholder="Nama Kompetensi" name="nama_kompetensi">
                            </div>
                            <div class="form-group">
