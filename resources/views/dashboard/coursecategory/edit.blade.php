        ...
        <div class="box_general padding_bottom">
            ...
            <form action="{{route('coursecategory.update', $data->id)}}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            {{-- <input type="text" value="{{$data->introduction}}" class="form-control"
                            name="introduction"> --}}
                            <textarea type="text" class="form-control"
                                name="introduction">{{old('introduction') ?? $data->introduction}}</textarea>
                ...
                <div class="form-group">
                    ...
                    <p><img alt="" class="img-fluid" style="width: 800px; height: 400px;" src="{{$data->image_url}}">
                    </p>
                    @else
